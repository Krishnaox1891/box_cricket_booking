    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <Link to="/venue-search-results" className="text-gray-600 hover:text-primary-600 font-medium">
            Find Venues
          </Link>
          <Link to="/player-profile-booking-history" className="text-primary-600 font-medium">
            My Bookings
          </Link>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 py-3 px-4 shadow-md">
          <nav className="flex flex-col space-y-4">
            <Link 
              to="/venue-search-results" className="text-gray-600 hover:text-primary-600 font-medium py-2"
              onClick={() => setIsMenuOpen(false)}
            >
              Find Venues
            </Link>
            <Link 
              to="/player-profile-booking-history" className="text-primary-600 font-medium py-2"
              onClick={() => setIsMenuOpen(false)}
            >
              My Bookings
            </Link>
